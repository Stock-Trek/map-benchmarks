...
pub const OUT_OF_THE_BOX_ENTRY_COUNT: &[usize] = &[10_000, 100_000, 1_000_000];

pub const SAME_HASHER_MAP_COUNT: usize = 1_000_000;
...
pub const MIXED_ENTRY_COUNT: &[usize] = &[10_000, 100_000, 1_000_000];
