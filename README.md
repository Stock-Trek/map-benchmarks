...
- **Throughput**: Uses a map with 10K entries. Use cases: [write-heavy, balanced, read-heavy]. Thread counts: [1, 2, 3]. Threads for concurrent tests are pinned to reduce any effects from OS scheduling.
