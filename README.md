...
- **Insert**: Inserts 10K new keys into maps containing 1K/10K/100K entries
...
- **Get or insert**: Uses maps containing 1K/10K/100K entries. Performs 10K get-or-insert operations on extant keys (hit path) and 10K on missing keys (insert path); for the 1K map the key counts are capped at 1K each
